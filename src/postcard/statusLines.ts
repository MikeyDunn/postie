...
export const STATUS_LINES: Record<string, string> = {
  ...
  failed: ':warning: Mailstream could not render the print proof — this card may not mail. Check the Mailstream dashboard.',
  ...
  returned: ':leftwards_arrow_with_hook: Returned to sender — check the address with `/postie status`.',
